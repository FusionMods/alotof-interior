 ...
 * interaction logic every such block calls into. {@link ChairBlock} is the only current
 * implementation - its no-backrest style returns {@code Float.POSITIVE_INFINITY} from
 * {@link #getMaxYawDeviation} (unrestricted free look), its backed styles a finite arc
 * derived from their facing property instead.
 */
