...
repositories {
    ...
    // continuityForgeVersion dependency below.
    exclusiveContent {
...
java {
    ...
    // See the toolchain comment in the root build.gradle.kts - without this,
    // runClient launches on whatever JDK the Gradle daemon started with,
    // which is how old Forge's mods.toml parsing ends up breaking under a
    // much newer JDK than javaVersion actually asks for.
